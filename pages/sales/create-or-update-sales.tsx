...
const schema = yup.object({
  ...
  phone: yup.number().required('price is required'),
  number: yup.number().required('price is required'),
  type: yup.string().required('type is a required field'),
  note: yup.string().required('detail is a required field'),
});
...
const CreateOrUpdateSales = ({
  ...
  useEffect(() => {
    if (sale) {
      const fields = ['animals', 'amount', 'type', 'note'];
  ...
  //   sort: 'asc',
  //   sortBy: 'createdAt',
  //   animalTypeId: dataAnimalTypes?.pages.,
  // });
