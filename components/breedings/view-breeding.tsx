            ...
            <form className="mt-4">
              <div className="flex-auto justify-center p-2">
                <div className="mb-4 flex items-center space-x-4">
                  <Input disabled type="text" value={OneBreeding.maleCode} />
                  <Input disabled type="text" value={OneBreeding.femaleCode} />
                </div>
                <div className="mb-4">
                  <Input disabled type="text" value={OneBreeding.method} />
                </div>
